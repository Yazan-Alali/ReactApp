  ...
  return (
    ...
    <div className="container space-y-3">
      ...
      <div className="content space-y-3">
        ...
        <div className="market-btns">
          <a href="#" className="store-btn">
            ...
            <img className="show-light" src="/icons/appstorlight.svg" alt=""/>
            <img className="show-dark" src="/icons/appdark.svg" alt=""/>
          </a>
          <a href="#" className="store-btn">
            <span className="sr-only">Get it on Google Play</span>
            <img className="show-light" src="/icons/googleplay-light.svg..svg" alt=""/>
            <img className="show-dark" src="/icons/googleplay-dark.svg.svg" alt=""/>
          </a>
        </div>
      ...
      <div className="phone-img-container">
        <img src="/icons/iphones.svg" alt="two iphones with charts and a creditcard on the screen" />
      </div>
